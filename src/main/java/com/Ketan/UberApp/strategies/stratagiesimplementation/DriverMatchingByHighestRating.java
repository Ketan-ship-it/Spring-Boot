...
public class DriverMatchingByHighestRating implements DriverMatchingStrategy {

    private final DriverRepository driverRepository;

    @Override
    public List<Driver> findNearByMatchingDriver(RideRequest rideRequest) {
        return driverRepository.findMatchingDriversByRating(rideRequest.getPickUpLocation());
    }
}
